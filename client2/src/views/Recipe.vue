                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-6 px-0 pr-md-3 mb-md-3 mb-3">
                            <div class="ingredients-container">
                                ...
                                <div v-else>
                                <Window v-if="ingredients.length > 0" title="Ingredients" icon="fas fa-pepper-hot" padding="0px">
                                        ...
                                        <div v-for="(ingredient, index) in ingredients" v-bind:key="index">   
                                            ...
                                            <div class="ingredient px-md-4 px-3 normalFont letter-spacing d-flex justify-content-between">
                                                <div 
                                                    ...
                                                    <span class="font-weight-bold">{{ingredient.fooditem_name}}</span>
                                                </div>
                        ...
                        <div class="col-lg-7 col-md-6 px-0 pl-md-3 mb-3">
                            <div class="instructions-container">
                                ...
                                <div v-else >
                                    <Window v-if="instructions.length > 0" title="Instructions" icon="fas fa-list-ol" padding="0px">
                        ...
                        <div class="col-12 px-0 mt-md-3 mt-0">
                            ...
                            <Window ref="ratings" v-else title="Ratings" icon="" padding="0px">
                                <div class="container-fluid review-container">
                                    <div class="row">
                                        <div class="col-12 px-md-4 py-md-4 px-3 py-3" v-if="isLoggedIn">
                                            <Rate @rated="rated" v-bind:max="5" v-bind:recipeId="parseInt(id)"></Rate>
                                        </div>

                                        <div class="col-12 px-md-4 py-md-4 px-3 py-3 d-flex justify-content-start align-items-center" v-else>
